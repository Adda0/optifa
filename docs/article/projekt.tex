...
\newcommand{\compatLA}{\emph{$\Phi$}^{LA}}
...
\extendedabstract{awdawdDo tohoto odstavce bude zapsán výtah (abstrakt) práce v českém (slovenském) jazyce.} % TODO
