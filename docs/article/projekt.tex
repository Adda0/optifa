...
\projectinfo{
  ...
  keywords.cs={Konečné automaty, Abstrakce jazyků stavů, Konstrukce produktu, Test prázdnosti, Optimalizace výpočtu průniku, Redukce stavového prostoru, SMT v\'ypočty, Délková abstrakce, Parikovské obrazy, Mintermizace}, % klíčová slova v českém či slovenském jazyce / keywords in czech or slovak language
  keywords.en={Finite Automata, State Languages Abstraction, Product Construction, Emptiness Test, Intersection Computation Optimization, State Space Reduction, SMT Solving, Length Abstraction, Parikh Image, Mintermization}, % klíčová slova v anglickém jazyce / keywords in english
